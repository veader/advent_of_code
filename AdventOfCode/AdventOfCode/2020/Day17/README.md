...
this initial state represents a small 2-dimensional slice of it. (_In particular, this initial state defines a 3x3x1x1 region of the 
4-dimensional space._)
