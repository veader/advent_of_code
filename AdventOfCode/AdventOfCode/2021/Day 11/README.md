...
They seem to not like the Christmas lights on your submarine, so you turn them off for 
now.
...
full. Although your lights are off, maybe you could navigate through the cave without 
...
level of each octopus (_your puzzle input_). For example:
...
level of all adjacent octopuses by `1`, including octopuses that are diagonally adjacent. If this 
...
(_An octopus can only flash at most once per step._)
